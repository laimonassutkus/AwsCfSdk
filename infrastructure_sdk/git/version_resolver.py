...
class GitVersionResolver:
    def __init__(self, git_repository_name: str):
        self.git_repository = git_repository_name

    def resolve(self, version_to_resolve, dev=True):
        """
        ...
        output = subprocess.check_output(
            ['git', 'ls-remote', '--tags', 'ssh://git@bitbucket.org/{}.git'.format(self.git_repository)])
